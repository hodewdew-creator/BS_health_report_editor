...
- 과체중 상태입니다. 우선은 현 체중의 10% 체중 감량을 추천드립니다.
- 감량 속도는 주당 1% 이내가 권장됩니다(지방간 위험 방지).
- 식이 조절과 먹이 퍼즐, 운동 등을 통해 적정 속도로 감량하세요.`,

  8: `비만 (BCS 8/9): 두터운 지방으로 인해 늑골(갈비뼈)이 잘 만져지지 않습니다. 허리가 구분되지 않으며, 복부가 전체적으로 둥글고 하복부 지방(fat pad)이 과다합니다.
- 비만 상태입니다. 활동성 감소가 있을 수 있으며, 주기적인 체중 측정과 체중 조절이 필요합니다.
- 우선은 현 체중의 15% 체중 감량을 추천드립니다(주당 1% 이내 권장).`,

  9: `중증 비만 (BCS 9/9): 두꺼운 지방층으로 늑골(갈비뼈)이 촉진되지 않습니다. 과다한 지방이 허리, 얼굴, 사지에 있습니다.
- 골관절염, 당뇨 등 동반 질환 위험이 높습니다. 주기적인 체중 측정과 체중 조절이 시급합니다.
- 우선은 현 체중의 20% 체중 감량을 추천드립니다(주당 1% 이내 권장).`,
};
