...
const key = {
  ...
  dentalOpts: "vetreport_dental_opts", // (과거 호환용, 유지 가능)
};
...
function DataBackupPanel(){
  const data = {
    ...
    // custom/templates는 기능 제거로 백업 대상에서 제외
  };
  ...
  return (
    <Card title="백업/복원" subtitle="핵심 데이터 저장/불러오기">
  ...
  return (
    <Card title="도움말" subtitle="설계 목표 & 사용 팁">
      <ul className="list-disc pl-5 space-y-1 text-sm text-slate-700">
        ...
        <li>백업/복원 기능으로 핵심 데이터 이동·복구 가능</li>
      </ul>
