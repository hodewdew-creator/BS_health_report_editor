...
<br>- 많이 야윈 상태입니다. 근육과 지방의 적절한 증량이 시급합니다. ",
  2: "저체중 (BCS 2/9): 털이 짧으면 육안상 늑골(갈비뼈)이 확인될 정도이며, 척추뼈가 도드라집니다. 만져지는 지방이 거의 없습니다.  
<br> - 야윈 상태입니다. 근육과 지방의 적절한 증량이 추천됩니다. ",
  3: "마른 편 (BCS 3/9): 지방량이 적어 늑골(갈비뼈)이 쉽게 만져지며, 허리뼈가 육안상, 촉진상 명확하게 도드라지고 복부에도 최소한의 지방만 존재합니다. 
<br> - 마른 상태입니다. 적절한 증량이 추천됩니다. .",
  4: "늑골(갈비뼈)이 적은 지방으로 덮여있으며, 늑골 뒤쪽으로 허리부위가 도드라지고 배가 살짝 나왔으며, 복부의 fat pad(아랫배지방)가 적은 상태입니다. 
<br> - 다소 마른 편이나 정상입니다. 주기적인 체중 체크를 해주세요.",
  5: "이상적 체형 (BCS 5/9): 적절한 체형입니다. 적정양의 지방이 덮힌 늑골(갈비뼈)이 만져지며, 뒤편으로 허리가 관찰됩니다. 최소의 fat pad (하복부 지방)가 확인됩니다.    
<br> - 이상적인 체형입니다. 주기적인 체중 체크를 해주세요.",
  6: "과체중 경향 (BCS 6/9): 적정량보다 약간 많은 지방이 늑골(갈비뼈)를 덮고 있고, 허리와 하복부 지방도 있는 편이나 심하지는 않습니다. 
<br> - 주기적인 체중 측정을 해주시고,  체중이 더 늘지 않도록 해주세요. ",
  7: "과체중 (BCS 7/9): 많은 지방때문에 늑골(갈비뼈)이 쉽게 만져지지 않습니다. 허리가 쉽게 구분되지 않습니다. 육안상 복부가 둥글게 관찰되며, 중등량의 하복부 지방이 확인됩니다.
<br> - 과체중 상태입니다. 주기적인 체중 측정을 해주세요. 우선은 현 체중의 10 %의 체중감량을 추천드립니다. 감량속도는 1주에 1% 이내가 권장됩니다. 너무 급한 체중감량은 지방간 위험성이 있으니, 식이 조절 및 먹이퍼즐, 운동등을 통해 적정 속도의 감량을 추천드리며, 감량속도는 1주에 1% 이내가 권장됩니다. ",
  8: "비만 (BCS 8/9): 두터운 지방으로 인해서 늑골(갈비뼈)이 잘 만져지지 않습니다. 허리가 구분되지 않으며, 복부가 전체적으로 둥글고, 하복부 지방량(fat pad)이 과다합니다.  
<br> - 비만 상태입니다. 이로 인한 활동성 감소가 있을 수 있으며, 주기적인 체중 측정과 체중조절이 필요합니다. 우선은 현 체중의  15%의 체중감량을 추천드립니다. 감량속도는 1주에 1% 이내가 권장됩니다. 너무 급한 체중감량은 지방간 위험성이 있으니, 식이 조절 및 먹이퍼즐, 운동등을 통해 적정 속도의 감량을 추천드리며, 감량속도는 1주에 1% 이내가 권장됩니다. ",
  9: "중증 비만 (BCS 9/9): 두꺼운 지방층으로 늑골(갈비뼈)이 촉진되지 않습니다. 과다한 여분의 지방이 허리, 얼굴, 사지에 있습니다. 
<br> - 비만 상태입니다. 골관절염, 당뇨 등 관련한 질환 발생 가능성이 높으며, 주기적인 체중 측정과 체중조절이 시급합니다. 우선은 현 체중의 20%의 체중감량을 추천드립니다. 너무 급한 체중감량은 지방간 위험성이 있으니, 식이 조절 및 먹이퍼즐, 운동등을 통해 적정 속도의 감량을 추천드리며, 감량속도는 1주에 1% 이내가 권장됩니다. 
",};
...
function makePhysText(p){
  ...
  const base = `체중 ${w}, ${bcsLine}. ${getBCSText(p.bcs)} ${trend}`;
