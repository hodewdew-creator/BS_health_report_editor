...
const DEFAULT_BCS_TEXT = {
  1: "심한 저체중 (BCS 1/9): 피하지방 소실, 갈비뼈/골능 매우 뚜렷.",
  2: "저체중 (BCS 2/9): 피하지방 감소, 갈비뼈 쉽게 만져짐.",
  3: "마른 편 (BCS 3/9): 갈비뼈 촉지 쉬움, 허리/복부 들어감.",
  4: "약간 마른 편 (BCS 4/9): 이상적에 근접하나 마른 경향.",
  5: "이상적 체형 (BCS 5/9): 갈비뼈 촉지 가능, 허리선/복부 탄력적.",
  6: "과체중 경향 (BCS 6/9): 지방 축적 시작, 허리선 둔화.",
  7: "과체중 (BCS 7/9): 갈비뼈 촉지 어려움, 복부 늘어짐.",
  8: "비만 (BCS 8/9): 피하지방 과다, 활동성 저하 가능.",
  9: "중증 비만 (BCS 9/9): 심한 지방 축적, 동반질환 위험 증가.",
};
